...
- name: AWS CloudFront API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/aws-cloudfront/master/_listings/aws-cloudfront/action-updatestreamingdistribution-get.md
x-common:
- type: x-analysis
